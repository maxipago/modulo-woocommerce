...
<fieldset id="maxipago-tef-form" class='wc-tef-form wc-payment-form'>
	...
	<p class="form-row form-row-wide">
		<label for="maxipago-ticket-document"><?php _e( 'CPF/CNPJ', 'woocommerce-maxipago' ); ?> <span class="required">*</span></label>
		<input id="maxipago-ticket-document" name="maxipago_ticket_document" class="input-text" type="tel" inputmode="numeric" maxlength="20" autocomplete="off" style="font-size: 1.5em; padding: 8px;" />
	</p>
	<div class="clear"></div>
</fieldset>
