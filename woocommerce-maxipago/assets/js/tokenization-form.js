    ...
    $(function () {
        var wcTokenizationForm = (function () {
            function wcTokenizationForm(target) {
                ...
                this.hideCvc = function () {
                    $('.fieldset-cvc-token', $formWrap).hide();
                };

                this.showCvc = function () {
                    $('.fieldset-cvc-token', $formWrap).show();
                };
