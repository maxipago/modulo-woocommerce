...
<fieldset id="maxipago-tef-form" class='wc-tef-form wc-payment-form'>
    ...
    <p class="form-row form-row-wide">
        <label for="maxipago-tef-document"><?php _e( 'Document Number', 'woocommerce-maxipago' ); ?> <span class="required">*</span></label>
        <input id="maxipago-tef-document" name="maxipago_tef_document" class="input-text" type="tel" inputmode="numeric" maxlength="20" autocomplete="off" placeholder="000.000.000-00" style="font-size: 1.5em; padding: 8px;" />
    </p>
	<div class="clear"></div>
</fieldset>
...
//<![CDATA[
    jQuery( function( $ ) {
        $( '#maxipago-tef-document' ).mask( '999.999.999-99' );
    });
//]]>
</script>