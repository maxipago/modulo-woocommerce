    ...
    <fieldset class="fieldset-cvc-token" style="display: none">
        <p class="form-row form-row-first">
            <label for="maxipago-card-cvc-token"
                   style="font-size: 1.20em;"><?php echo __('Security Code', 'woocommerce-maxipago') ?><span
            ...
            <input id="maxipago-card-cvc-token" name="maxipago_card_cvc_token"
                   ...
                   placeholder="<?php echo esc_attr__('CVV', 'woocommerce-maxipago') ?>"
...
<fieldset>
    <?php
        ...
        {
            ?>
                <input type="hidden" name="maxipago_installments" value="1"/>
            <?php
        } else
        {
            ?>
                <p class="form-row form-row-wide">
                    <label for="maxipago-installments" style="font-size: 1.20em;"><?php echo _e('Installments', 'woocommerce-maxipago'); ?><span class="required">*</span></label>
    ...
    <p class="form-row form-row-wide">
        <label for="maxipago-cc-document"><?php echo _e('CPF/CNPJ', 'woocommerce-maxipago'); ?> <span
                    class="required">*</span></label>
        <input id="maxipago-cc-document" name="maxipago_cc_document" class="input-text" type="tel" inputmode="numeric"
